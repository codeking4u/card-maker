...
<div class="creator-inner-container">
	<div>
		...
		<div>
			<img id="normal" src="{{ asset('storage/page_img/cards/yugioh/anime/Normal.png') }}">
			<img id="effect" src="{{ asset('storage/page_img/cards/yugioh/anime/Effect.png') }}">
			<img id="ritual" src="{{ asset('storage/page_img/cards/yugioh/anime/Ritual.png') }}">
			<img id="fusion" src="{{ asset('storage/page_img/cards/yugioh/anime/Fusion.png') }}">
			<img id="synchro" src="{{ asset('storage/page_img/cards/yugioh/anime/Synchro.png') }}">
			<img id="xyz" src="{{ asset('storage/page_img/cards/yugioh/anime/Xyz.png') }}">
			<img id="link" src="{{ asset('storage/page_img/cards/yugioh/anime/Link.png') }}">
			<img id="spell" src="{{ asset('storage/page_img/cards/yugioh/anime/Spell.png') }}">
			<img id="trap" src="{{ asset('storage/page_img/cards/yugioh/anime/Trap.png') }}">
			<img id="pendulum" src="{{ asset('storage/page_img/cards/yugioh/anime/Pendulum.png') }}">
		</div>
